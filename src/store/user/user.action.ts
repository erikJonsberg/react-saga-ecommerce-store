...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, {user: User, additionalInfo: AdditionalInformation}>;
...
export const signUpSuccess = withMatcher(
    (user: User, additionalInfo: AdditionalInformation): SignUpSuccess => 
